 ...
 */
export declare const checkExpiredTrades: import("firebase-functions/v2/scheduler").ScheduleFunction;
...
export declare const executeTrade: import("firebase-functions/v2/https").HttpsFunction;
export declare const scheduleSellOrder: import("firebase-functions/v2/https").HttpsFunction;
export declare const getOrders: import("firebase-functions/v2/https").HttpsFunction;
